...
{ 
    ...
    // my add
    py::class_<SarADC>(m, "SarADC")
        .def(py::init<InputParameter &,Technology &,MemCell &>())
        .def("Configure", &SarADC::Initialize)
        .def("CalculateUnitArea", &SarADC::CalculateUnitArea)
        .def("CalculateArea", &SarADC::CalculateArea)
        .def("CalculateLatency", &SarADC::CalculateLatency)
        .def("CalculatePower", &SarADC::CalculatePower)
        .def_readwrite("area", &SarADC::area)
        .def_readwrite("readLatency", &SarADC::readLatency);
    // my add
